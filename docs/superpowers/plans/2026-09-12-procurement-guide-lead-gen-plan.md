...
4. **Resolve the missing funnel events from that manual test** (read-only diagnosis first; record below). PR #52 is not marked ready until this is explained.
