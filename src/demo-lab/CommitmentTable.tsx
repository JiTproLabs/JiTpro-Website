...
import { COLUMNS, ROWS, STATUS_LABEL, type Status } from './commitmentFixtures';

/**
 * The Commitment Register table, extracted so the fidelity test can render it
 * in isolation beside the reference crop.
 *
...
function StatusBadge({ status }: { status: Status }) {
  const map = {
    ...
    'at-risk': {
      ...
      icon: (
        <span
          style={{ width: 6, height: 6, borderRadius: 999, background: 'var(--jpd-warn-dot)', display: 'block' }}
        />
      ),
    },
    overdue: {
