              ...
              <div className="space-y-6">
                <div>
                  <label className={labelClass}>
                    Do you have an upcoming project where procurement decisions may affect the construction schedule?
                  </label>
                ...
                {hasProject === 'yes' && (
                  <div className="space-y-6">
                    ...
                    <div>
                      <label htmlFor="procurementMethod" className={labelClass}>Procurement Coordination</label>
                      <select id="procurementMethod" value={procurementMethod} onChange={(e) => setProcurementMethod(e.target.value)} className={inputClass}>
                        ...
                        <option value="through-gc">Through the general contractor</option>
                        <option value="design-team">Through design team coordination</option>
                        <option value="during-construction">Informally during construction</option>
                        <option value="not-tracked">Not formally tracked</option>
                        <option value="other">Other</option>
                      </select>
                    </div>
                  </div>
