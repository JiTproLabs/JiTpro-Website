    ...
    <div className="bg-white text-slate-900">
      ...
      <section className="relative overflow-hidden bg-slate-950 text-white px-6 py-24 md:py-32">
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at 18% 22%, rgba(245,158,11,0.20), transparent 30%), radial-gradient(circle at 80% 8%, rgba(59,130,246,0.12), transparent 28%)',
          }}
        />
      ...
      {/* SAME MISTAKES */}
      <section id="same-mistakes" className="px-6 py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[0.9fr_1.1fr] gap-12 items-start">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 md:p-8 shadow-xs">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-bold">The same misses keep showing up</h3>
            </div>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1fr_1fr] gap-10 items-center">
          ...
          <div className="rounded-3xl border border-red-300/20 bg-red-500/10 p-6 md:p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-bold">Firefighting is still procurement work</h3>
            </div>
      ...
      <section className="px-6 py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[0.9fr_1.1fr] gap-10 items-stretch">
          <div className="rounded-3xl bg-slate-900 text-white p-7 md:p-9">
          ...
          <div className="rounded-3xl border border-amber-300/30 bg-amber-50 p-7 md:p-9">
            <ShieldCheck className="text-amber-700 mb-6" size={40} />
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-slate-900 leading-tight mb-5">
