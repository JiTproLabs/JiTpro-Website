        ...
        <div className="max-w-4xl mx-auto space-y-16">
          <div>
            ...
            <p className="text-lg text-slate-600 leading-relaxed mb-4">
              Every approval is recorded with exact date and time. Who approved, what they approved, and when they approved it. No ambiguity.
            </p>
            <p className="text-lg text-slate-600 leading-relaxed">
              Once an approval is finalized, the record locks. No editing. No revisions. The history is permanent and verifiable.
            </p>
          </div>
