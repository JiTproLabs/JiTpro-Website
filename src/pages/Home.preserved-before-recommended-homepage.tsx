    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <section className="relative overflow-hidden border-b border-white/10 bg-slate-950">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32 lg:py-36">
          ...
          <div className="mx-auto mt-16 max-w-6xl rounded-2xl border border-white/10 bg-white/[0.035] p-3 shadow-[0_0_0_1px_rgba(255,255,255,0.03)] backdrop-blur-sm md:p-4">
              ...
              <div className="lg:hidden">
                <div className="divide-y divide-slate-800">
                  {exposureRows.map((row) => (
                    <div key={row.item} className="px-5 py-5">
                      <div className="mb-3 flex items-start justify-between gap-4">
                        <div>
                          <p className="font-mono text-[10px] font-medium uppercase tracking-[0.16em] text-slate-500">Critical Package</p>
                          <h3 className="mt-1 font-heading text-lg font-semibold text-slate-100">{row.item}</h3>
                        </div>
                        <MarginExposureBadge tone={row.tone}>{row.exposure}</MarginExposureBadge>
                      </div>
                      <div className="grid gap-3 text-sm sm:grid-cols-2">
                        <div className="rounded-lg border border-slate-800 bg-slate-950/60 p-3">
                          <p className="font-mono text-[10px] font-medium uppercase tracking-[0.16em] text-slate-500">Waiting On</p>
                          <p className="mt-1 text-slate-300">{row.waitingOn}</p>
                        </div>
                        <div className="rounded-lg border border-slate-800 bg-slate-950/60 p-3">
                          <p className="font-mono text-[10px] font-medium uppercase tracking-[0.16em] text-slate-500">Next Consequence</p>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
            ...
            <div className="space-y-6 text-lg leading-8 text-slate-300">
              ...
              <p>
                They lose it when the field is forced to recover from something that should have been resolved earlier: a decision not made, an approval not returned, a release missed, a fabrication window lost, or a delivery that no longer matches the schedule.
              </p>
              <p className="font-heading text-2xl font-600 leading-snug text-slate-100">
                That is procurement.
              </p>
              <p>
                Not just purchasing. Not just buyout. Procurement is the path from decision to delivery: the decisions, approvals, submittals, releases, fabrication, and logistics required before the field can build.
              </p>
              <p>
                When that path breaks, the schedule absorbs it first.
              </p>
              <p>
                Then the margin does.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-950 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
            <div>
              <p className="mb-4 font-mono text-xs font-medium uppercase tracking-[0.2em] text-amber-500">Why it happens</p>
              <h2 className="font-heading text-4xl font-700 tracking-tight text-slate-50 md:text-5xl">
            ...
            <div className="space-y-6 text-lg leading-8 text-slate-300">
              <p>
                The moment a project is awarded, unresolved owner decisions, incomplete design, open assumptions, and external constraints begin moving toward the GC.
              </p>
              <div className="space-y-2 font-heading text-2xl font-600 leading-snug text-slate-100">
                <p>The GC may not own the decision.</p>
                <p>The GC may not control the design.</p>
                <p>The GC may not control the utility, approval, selection, or vendor response.</p>
              </div>
              <p>
                But once the project starts, the schedule pressure lands on the GC anyway.
              </p>
              <p>
                That is silent risk transfer: upstream uncertainty becoming downstream responsibility before anyone names it, sequences it, or assigns it a date.
              </p>
              <p>
                JiTpro gives that transferred risk a visible structure so your team can see what has moved onto your plate, who still owns the answer, and when it must be resolved before margin becomes recovery cost.
              </p>
            </div>
          </div>
        </div>
