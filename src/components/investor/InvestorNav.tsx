      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-28">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <div ref={briefRef} className="relative">
            ...
            {briefOpen && (
              <div className="absolute right-0 mt-1 w-40 bg-slate-900 border border-slate-800 rounded-sm shadow-lg py-1 z-50">
          ...
          {activeDataRoomPage && (
            <button
              ...
              className="ml-2 px-3 py-2 text-sm rounded-sm border border-amber-500/40 text-amber-500 hover:bg-amber-500/10 transition-colors flex items-center gap-1.5"
            >
              <Download size={14} />
          ...
          {activeDataRoomPage && (
            <div className="border-t border-slate-800 pt-3 mt-2">
              <button
                ...
                className="w-full px-3 py-2.5 text-sm rounded-sm border border-amber-500/40 text-amber-500 hover:bg-amber-500/10 transition-colors flex items-center justify-center gap-1.5"
              >
                <Download size={14} />
                {activeDataRoomPage.downloadLabel}
              </button>
